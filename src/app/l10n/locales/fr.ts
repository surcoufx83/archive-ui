...
export const L10nArchiveFrLocale: L10nArchiveLocale = {
    ...
    classify: {
        classes: {
            ...
            Banking_AnnualMeeting: "Assemblée générale",
            Banking_AnnualReport: "Rapport annuel (compte)",
            Banking_AnnualStmt: "Relevé annuel de compte",
            Banking_BuyOrders: "Ordre d'achat de titres",
            Banking_CancelOrders: "Annulation d'ordre de titres",
            Banking_CostStmt: "État des coûts",
            Banking_DepositStatement: "Relevé de portefeuille",
            Banking_Earnings: "Revenus bancaires/transactions boursières",
            Banking_LossOffSetting: "Compensation de pertes",
            Banking_Order: "Ordre de titres",
            Banking_SellOrders: "Ordre de vente de titres",
            Banking_Stmt: "Relevé de compte",
            Claim_Settlement: "Règlement de sinistre",
            Contract_Adjustment: "Ajustement du contrat",
            Contract_Amendment: "Avenant au contrat",
            Contract_Application: "Demande de contrat",
            Contract_Information: "Informations générales",
            Contract_Proposal: "Projet de contrat",
            Contract_Protocol: "Compte rendu de conseil",
            Contract_Renewal: "Renouvellement du contrat",
            Contract_Termination: "Confirmation de résiliation, dissolution",
            Contract_ToS: "Conditions générales",
            Contract: "Contrat",
            Finance_CreditNote: "Note de crédit",
            Finance_Donation: "Reçu de don",
            Finance_Invoice: "Facture",
            Finance_Reminder: "Rappel de paiement",
            General_AnnualReport: "Rapport annuel",
            General_Approval: "Approbation / Autorisation",
            General_DeliveryNote: "Bon de livraison",
            General_DeviceInfo: "Données de l'appareil",
            General_IdDocuments: "Pièces d'identité etc.",
            General_Letter: "Lettre générale",
            General_Mailbody: "E-mail",
            General_Manuals: "Manuel",
            General_Order: "Commande",
            General_OrderConfirmation: "Confirmation de commande/achat",
            General_Unclassified: "Courrier général",
            Health_Medication: "Ordonnance (médicaments/traitements)",
            Health_Report: "Rapport médical",
            Home_AnnualSettlement: "Règlement des charges locatives",
            Home_MeterReading: "Relevé de compteur",
            In_PerformanceReport: "Rapport de performance financière",
            In_PostReceipt: "Reçu de dépôt courrier/colis",
            In_QuarterReport: "Rapport trimestriel",
            In_Receipt: "Reçu de caisse",
            In_Receipt2: "Reçu",
            In_Rejection: "Rejet, avis de rejet",
            In_RepairOrder: "Ordre de réparation",
            In_RepairReport: "Rapport de réparation",
            In_Request: "Demande",
            In_Statement: "Attestation générale",
            In_Stock_Info: "Information sur les titres",
            In_TaxAssessment: "Avis d'imposition",
            ...
            In_TicketEntrance: "Billet d'entrée",
            In_TicketTransport: "Ticket de transport",
            In_TrafficTicket: "Amende de circulation",
            ...
            Insurance_Stmt: "Attestation de sécurité sociale",
            Job_AnnualBonus: "Prime annuelle, paiements spéciaux, etc.",
            Job_AnnualPayroll: "Certificat de salaire",
            Job_Application: "Candidature",
            Job_Certificate: "Certificat, diplôme, attestation de participation",
            Job_CoD: "Certificat d'incapacité de travail",
            Job_Expenses_Clearing: "Validation/remboursement des frais",
            Job_Incentives_Status: "Statut lead/incentive",
            Job_PaySlip: "Bulletin de salaire",
            Job_PaySlip2: "Bulletin de salaire",
            LeaseAgreement: "Contrat de bail",
            Legal_Deed: "Acte authentique",
            Legal_LayJudge_CompensationForm: "Assesseur : formulaire d'indemnisation",
            Legal_LayJudge_InvitationTrial: "Assesseur : convocation audience",
            Legal_LayJudge_ReservedDates: "Assesseur : dates disponibles",
            Legal_Mandate: "Mandat, procuration",
            Legal_Notice: "Avis de procédure",
            NewCard: "Nouvelle carte avec lettre",
            Out_ClaimReport: "Déclaration de sinistre",
            Out_Contradiction: "Opposition",
            Out_ExpenseReport: "Note de frais et justificatifs",
            Out_Inquiry: "Demande",
            Out_Questionnaire: "Questionnaire",
            Out_Revocation: "Révocation",
            Out_SepaMandate: "Mandat de prélèvement SEPA",
            Out_TaxDeclaration: "Déclaration d'impôts",
            Out_Termination: "Résiliation",
            Pension_AnnualReport: "Rapport annuel (retraite)",
            Public_Application: "Candidature (secteur public)",
            Public_BallotDocs: "Documents électoraux",
            RentalAgreement: "Contrat de location",
            Security_Credentials: "Identifiants, mots de passe",
            Trash: "Corbeille",
        },
    },
    common: {
    ...
    listManager: {
        ...
        list: {
            ...
            completed: "{0} terminé",
            dropzone: "Glissez ici",
            incomplete: "{0} en cours",
    ...
    travel: {
        createReportBtn: "Rapport Annuel",
        pagetitle: "Voyages d'affaires",
        colActions: "Actions",
        colBegin: "Du",
        colEnd: "Au",
        colLocation: "Lieu",
